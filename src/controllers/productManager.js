...
export class Product {
    constructor(title, description, category, price, status, thumbnail, code, stock) {
        this.title = title
   ...
   async cargar () {
        ...
        timer:500
        const product2 = new Product("Yogurt", "Natural", "lacteos", 400, true, "Sin imagen", "lac101", 20)
        await productManager.addProduct(product2)
        timer:500
        const product3 = new Product("Queso", "Cremoso", "lacteos", 2000, true, "Sin imagen", "lac102", 20)
        await productManager.addProduct(product3)
        timer:500
        const product4 = new Product("Manteca", "Natural", "lacteos",  400, true, "Sin imagen", "lac103", 20)
        ...
        timer:500
        const product8 = new Product("Tapa de Asado", "Novillito", "carnes", 2000, true, "Sin imagen", "Asa102", 20)
        await productManager.addProduct(product8)
        timer:500
        const product9 = new Product("Falda", "Novillito", "carnes", 1500, true, "Sin imagen", "Asa103", 20)
        await productManager.addProduct(product9)
        timer:500
        const product10 = new Product("Entrecot", "Novillito", "carnes", 2000, true, "Sin imagen", "Asa104", 20)
        await productManager.addProduct(product10)
        }
    } 

const productManager = new ProductManager('./src/products.json')
const product1 = new Product("Leche", "Entera", "lacteos", 1000, true, "Sin imagen", "lac100", 20)
product1.cargar()
